            ...
            <div class="pb-12 md:pb-14">
              <div class="relative text-center md:text-left">
                ...
                <p
                  ...
                  data-aos-delay="200"
                >
                  HR Globe is a professional full-service recruitment company
                  that helps Canadian companies and businesses source for top
                  international talents, strengthening human resources, and
                  providing excellent and top-notch immigration consulting
                  services. Our international recruitment service is aimed at
                  attracting the most qualified talents to Canadian firms,
                  filling challenging positions that requires the unique
                  combination of expertise, skillsets, professionalism, and
                  industry requirements. We have We have a number of dispatch
                  packages and plans for our clients, customers, and partners to
                  choose from.
                </p>
              </div>
            </div>
