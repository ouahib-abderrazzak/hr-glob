    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-8">
        ...
        <div class="relative py-12 px-8 md:py-20 md:px-12">
          <!-- Dark box -->
          <div
            class="absolute inset-0 bg-gray-800 -rotate-2 -z-10"
            aria-hidden="true"
          ></div>
          ...
          <div class="flex flex-col lg:flex-row justify-between items-center">
            <!-- CTA content -->
            <div
              class="relative mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left"
            >
              <svg
                class="absolute left-0 bottom-full mb-4"
                width="82"
                height="75"
              ...
              <h3 class="h2 font-cabinet-grotesk text-gray-100">
