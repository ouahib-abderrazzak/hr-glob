            ...
            >
              ...
              <ol class="list-decimal">
                <li
                  ...
                  v-for="(item, index) in [
                    'Aged 22 to 55',
                    '2 to 3 years of minimum experience in their professional field',
                    'Language: French and/or English',
                    '11 years of recognized schooling',
                    'Lack of criminal record',
                    'Valid passport',
                    `Valid driver's license (depending on trade/profession)`,
                    'Self-sufficient for expenses related to coming to Canada',
                  ]"
                  :key="index"
                >
                  {{ item }}
